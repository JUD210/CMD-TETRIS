...
void song_play()
{
    ...
    {
        //PlaySound(NULL, 0, 0);
        //PlaySound(TEXT("BGM001-Bradinsky"), NULL, SND_ASYNC | SND_L■P);
        delay_dance = 345;
        song = 0;
        song_counter[0] = 0;
    }
    ...
    {
        //PlaySound(NULL, 0, 0);
        //PlaySound(TEXT("BGM002-Troika"), NULL, SND_ASYNC | SND_L■P);
        delay_dance = 408;
        song = 0;
        song_counter[1] = 0;
    }
    ...
    {
        //PlaySound(NULL, 0, 0);
        //PlaySound(TEXT("BGM003-Kalinka"), NULL, SND_ASYNC | SND_L■P);
        delay_dance = 406;
        song = 0;
        song_counter[2] = 0;
    }
