    ...
    for (i = 0; i < 25; i++) // Main Game size : (0,0)~(24,24)
    {
        ...
        for (j = 0; j <= 11; j++)
        {
            ...
            else if (debug == 0)
            {
                ...
                //system(7,0) ㅁ(14,0)노랑 ㅡ빨강(12,0) ㅗ(10,0)초록 ㄴ(11,0)하늘 ㄴrev흰(15,0) ㄹ파랑(9,0) ㄹrev보라(13,0)
...
void block(int input_shape, int input_x, int input_y, int move_x, int move_y, int input_rotate, int input_state)
//shape  // 0:system, 1:ㅁ , 2:ㅡ , 3: ㅗ, 4:ㄴ , 5: ㄴ(rev), 6:ㄹ, 7:ㄹ(rev)
//색 정렬 // system(7,0) ㅁ(14,0)노랑 ㅡ빨강(12,0) ㅗ(10,0)초록 ㄴ(11,0)하늘 ㄴrev흰(15,0) ㄹ파랑(9,0) ㄹrev보라(13,0)
